...
require_once( WPSC_FILE_PATH . '/wpsc-admin/display-Order.php' );
...
function wpsc_admin_pages() {
	...
	$page_hooks[] = $edit_coupons_page = add_submenu_page( $products_page , __( 'Coupons', 'wpsc' ), __( 'Coupons', 'wpsc' ), $manage_coupon_cap, 'wpsc-edit-coupons', 'wpsc_display_coupons_page' );
       ...
       // set the base page for order 
$page_hooks[] = $edit_Order_page = add_submenu_page( $products_page , __( 'Order', 'wpsc' ), __( 'Order', 'wpsc' ), 'read', 'wpsc-edit-Order', 'wpsc_display_Order_page' );
