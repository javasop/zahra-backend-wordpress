...
class Booklet extends Zahra_API {

    public function register_routes($routes) {
        $routes['/zahra/booklets'] = array(
    ...
    public function get_posts($filter = array(), $context = 'view', $type = 'booklets', $page = 1) {

        $posts = parent::get_posts($filter, $context, 'booklets', $page);
